export const constants = {
  ...
  PARA2: `Once you've hit that submit button, our team will carefully review your application. If you're selected for the category you applied to, we'll reach out to you using the email you provided.
    Beneficiaries will be contacted at most three weeks from Friday 9, which is when the application closes.`,
  PARA3:
  ...
  we'll reach out to you using the email you provided. Beneficiaries will be contacted at most three weeks from Friday 9, which is when the application closes.`,
