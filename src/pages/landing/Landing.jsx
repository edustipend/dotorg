    ...
    <div className="top-main">
      <div className="top-main-child">
        <h1 className="page-header">
          <p>
            Need some <span className="header-primary">stipend</span> for your
            learning?
          </p>
        </h1>
        <h3 className="page-subheader">
          Get funding for your learning needs from anonymous folks and from
          people who care
        </h3>
    ...
    <div className="middle-main" id="howitworks">
      <div className="section-child middle-main-left">
        ...
        <p className="page-text">
          The <b>3Rs</b>: <b>R</b>equest, <b>R</b>eview, <b>R</b>eceive describe
          the process for requesting support.
        </p>
        <p className="page-text">
          Our goal is to help get you to <b>A</b> - our desired end result,
          which is to <b>A</b>chieve. To achieve your learning goals.
        </p>
