	...
	return (
		<div className='top-main' style={{ backgroundColor: 'paleturquoise' }} id='eligibility'>
			<div className='top-main-child'>
				...
				<div>
					<h3 className='page-subheader'>The appliation is open to past beneficiaries of Edustipend monthly stipend and any candidate who can show the following: </h3>
