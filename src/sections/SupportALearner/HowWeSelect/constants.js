...
export const how = [
  {
    ...
    id: '01',
    description:
      'Our vision is to support folks who really need a push with their lerning goals. As part of the application, you should show how you really need the stipend and how getting the stipend can help you chieve your learning goals '
  },
  {
    label: 'PROGRESS SO FAR',
    id: '02',
    description:
      'Everyone needs a laptop or data, we would like to see what they have achieved so far without the stipend . It could be a course or community you joined. We know it can be hard but the more you can demonstrate progress despite the constraints, the better your chances'
  },
  {
    label: 'DEMOGRAPHY',
    id: '03',
  ...
  },
  {
    ...
    id: '04',
    description:
      'We do not ask for an entire epistle when asbpart of your application but we reall appreciate thoughtful responses. So answer all questions as descriptive yet concisely  as possible . Let your personality show in your application'
  },
  {
    label: 'FUTURE IMPACT',
    id: '05',
