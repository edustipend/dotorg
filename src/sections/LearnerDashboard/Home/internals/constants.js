...
export const tableHead = ['ID', 'Stipend Category', 'Application Status', 'Date of submission'];
export const submissionTableHead = ['ID', 'Stipend Category', 'Application Status', 'Date of submission'];
