...
const headText = 'Stipend Application  January 2024';
const p1 = 'Hello there, Welcome to the month of January, how time flies! 🎉🎊';
const p2 =
...
const p3 =
  'Kindly note that this form will be closed for the January window by 11.00pm WAT on Friday, January  26, 2024  do well to complete it before that time.';
